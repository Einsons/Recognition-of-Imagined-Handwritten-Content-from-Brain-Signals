...
The strongest leakage-free multi-architecture OOF ensemble reaches **27.18%** held-out test accuracy. Reproduce it with `python src/evaluate_oof_multiarch_ensemble.py` after training the DCN and EEGNet folds described in `EXPERIMENTS_README.md`.
